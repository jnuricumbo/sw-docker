...
# Add info
sudo cp /install/info.php /var/www/shopware/public/info.php
# Adapt ini
...
# sudo chown www-data:www-data /var/www/shopware/config/jwt/private.pem
# sudo chown www-data:www-data /var/www/shopware/config/jwt/public.pem
